...
public class ChangedBusTicket extends JFrame{
...
LineBorder buttonBorder2=new LineBorder(new Color(128,128,128),3);
  ...
  public ChangedBusTicket(final String orderid,final String tripno,final String seatno){
     ...
     Route route=null;
     Seat seat=null;
     String paymentid=payControl.getPaymentId(orderid);
     seat=seatControl.selectDeck(seatno);
     trip=tripControl.selectRecord(tripno);
     ...
     +trip.getDepartdate().toString()+"\nTrip Time (24 hrs): "+trip.getDeparttime()+"\nTrip Price: RM"
     +String.format("%.2f",trip.getTripprice())+"\n\n";;
  ...
  private class PrintListener implements ActionListener
  {
   ...
   private void setIcon() {
    ...
    {
         new ChangedBusTicket("ODA0000002","ASBPS2303160000","SA05");
